                                ...
                                <tr>
                                    <?php
                                        try {
                                            ...
                                            // Truy vấn SQL, lọc đơn hàng theo từ khóa tìm kiếm
                                            $sql = "
                                                SELECT 
                                                    orders.*, 
                                                    order_details.*, 
                                            ...
                                            if ($search !== '') {
                                                $sql .= " AND (orders.fullname LIKE '%$search%' 
                                                              OR product.title LIKE '%$search%' 
                                                              OR product_size.size LIKE '%$search%' 
                                                              OR orders.phone_number LIKE '%$search%' 
                                                              OR orders.address LIKE '%$search%' 
                                                              OR orders.status LIKE '%$search%')";
                                            }

                                            // Thêm phân trang
                                            $sql .= " ORDER BY orders.order_date DESC LIMIT $start, $limit";
                                            ...
                                            foreach ($order_details_List as $item) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="manager_edit_order.php?order_id=' . $item['order_id'] . '">
