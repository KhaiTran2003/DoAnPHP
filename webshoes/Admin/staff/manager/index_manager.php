        ...
        <main class="py-6 bg-surface-secondary">
            <div class="container-fluid">
                ...
                <div class="row g-6 mb-6">
                    ...
                    <a href="../manager/product/manager_product.php" class="card shadow border-0 clickable-card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                ...
                <div class="col-xl-3 col-sm-6 col-12">
                    <a href="../manager/user/manager_user.php" class="card shadow border-0 clickable-card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                ...
                <div class="col-xl-3 col-sm-6 col-12">
                <a href="../manager/order/manager_order.php" class="card shadow border-0 clickable-card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
            ...
            <div class="col-xl-3 col-sm-6 col-12">
                <a href="../manager/staff/manager_staff.php" class="card shadow border-0 clickable-card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
