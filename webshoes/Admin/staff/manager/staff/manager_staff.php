        ...
        <main class="py-6 bg-surface-secondary">
            ...
            <div class="card shadow border-0 mb-7">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="add_staff.php" class="btn d-inline-flex btn-sm btn-primary mx-1">
                        <span class="pe-2">
                    ...
                    <table class="table table-hover table-nowrap">
                        ...
                        <tbody>
                            <?php
                                ...
                                try {
                                    // Lấy từ khóa tìm kiếm từ form hoặc URL
                                    ...
                                    // Cập nhật câu SQL với điều kiện tìm kiếm
                                    $sql = "
                                        SELECT r.*, u.fullname, u.dienthoai 
                                        FROM role r 
                                        LEFT JOIN user u ON r.id_role = u.role 
                                        WHERE r.id_role NOT IN (1, 2)
                                    ";

                                    // Thêm điều kiện tìm kiếm nếu có
                                    if ($search !== '') {
                                        $sql .= " AND (r.role_name LIKE '%$search%' OR u.fullname LIKE '%$search%' OR u.dienthoai LIKE '%$search%')";
                                    }
                                    ...
                                    foreach ($roleList as $role) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-heading font-semibold">' . $role['permissions'] . '</td>
                                            <td class="text-heading font-semibold">' . $role['created_at'] . '</td>
                                            <td>
                                                <a href="edit_staff.php?id_role=' . $role['id_role'] . '">
