                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-4">
                            <div class="left-header clearfix">
                                <ul>
                                    <li><p><i class="fa fa-phone" aria-hidden="true"></i>(+84) 34 577 5579</p></li>
                                    <li class="hd-none"><p><i class="fa fa-clock-o" aria-hidden="true"></i>Thứ 2 - 7 : 8:00 AM - 10:00 PM</p></li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <ul>
                                    ...
                                    if(isset($_COOKIE['tendangnhap'])) {
                                        ...
                                        if ($result && mysqli_num_rows($result) > 0) {
                                            ...
                                            echo '<li><a style="color:#00FFFF; font-weight: 500; text-transform: uppercase;" href="">Xin chào ' . $_COOKIE['tendangnhap'] . '!' . '</a>
                                                    <ul><div class="logout">';
                                            if ($user['role'] == 1) {
                                                echo '
