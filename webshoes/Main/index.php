        ...
        <div class="row">
            <div id="blog" class="owl-carousel product-slider owl-theme re-blog">
                <div class="col-xs-12">
                    <div class="blog-container-inner">
                        <div class="post-thumb">
                            <a href="Blog2.php"><img class="attachment-blog-list wp-post-image" alt="blog-2" src="images/new1.jpg"></a>
                        </div>
                ...
                <div class="col-xs-12">
                    <div class="blog-container-inner">
                        <div class="post-thumb">
                            <a href="Blog1.php"><img class="attachment-blog-list wp-post-image" alt="blog-2" src="images/new2.jpg"></a>
                        </div>
                        <div class="visual-inner">
                            <h2 class="blog-title">
                            ...
                            <div class="blog-meta">
                                <span class="post-category">
                                    in
                                    <a rel="category" href="Blog1.php">Toryco 1993 Store</a>
                                </span>
                                <span class="published">
                                    <i class="fa fa-clock-o"></i>
                                    Oct 31, 2023
                ...
                <div class="col-xs-12">
                    <div class="blog-container-inner">
                        ...
                        <div class="box-left" >
                            <a href="Blog1.php"><button>Xem thêm </button><!--nút mua hàng --></a>
                        </div>
                    </div>
                </div>
                <!-- single blog item end -->
